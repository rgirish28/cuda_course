...
// We only need this for the OpenMP timing functions
#include <string.h>
...
#include "tut3_concurrency_solution_question1.h"
//#include "tut3_concurrency_solution_question2.h"
//#include "tut3_concurrency_solution_question3.h"
//#include "tut3_concurrency_solution_question4.h"
...
int main()
{
	...
	question1(m, n, k, nMatrices);
	//question2(m, n, k, nMatrices);
	//question3(m, n, k, nMatrices);
	//question4(m, n, k, nMatrices);
